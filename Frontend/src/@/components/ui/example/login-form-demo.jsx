...
export default function LoginupFormDemo() {
  ...
  return (
    ...
    <div
      className="max-w-md w-full mt-5 mx-auto rounded border border-[#575454] md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      <h2 className="font-bold text-2xl text-neutral-800 dark:text-neutral-200">
        Welcome to Echoes Insights
      </h2>
      ...
      <form className="my-8 mt-14" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-8">
          <Label htmlFor="twitterpassword">OTP</Label>
